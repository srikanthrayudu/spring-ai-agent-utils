 ...
 * <p>Run with:
 * <pre>
 *   mvn exec:java -Dexec.mainClass="org.springaicommunity.agent.ikos.KefDemo"
 * </pre>
 *
 * @author Antigravity
 */
public class KefDemo {
    ...
    private void listAllMemory() {
        ...
        List<org.springaicommunity.agent.ikos.model.KnowledgeUnit> all = storage.listKnowledgeUnits();
        if (all.isEmpty()) {
